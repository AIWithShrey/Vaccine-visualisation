...
vacc = pd.read_csv('Path of the downloaded vaccination csv file to be inserted here. Be sure to download it from the official WHO website as the column headings must remain intact.')
